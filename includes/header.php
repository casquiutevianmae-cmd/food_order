...
$is_subfolder = (strpos($script_name, '/auth/') !== false || strpos($script_name, '/user/') !== false || strpos($script_name, '/reports/') !== false || strpos($script_name, '/inventory/') !== false);
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarMain">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 align-items-lg-center">
                ...
                <li class="nav-item">
                    <a class="nav-link px-3" href="<?= $base_path ?>task.php">
                        <i class="bi bi-calculator me-1"></i> Task Estimator
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link px-3" href="<?= $base_path ?>food_order-js.php">
                        <i class="bi bi-cart-check me-1"></i> Food Ordering
                    </a>
                </li>
